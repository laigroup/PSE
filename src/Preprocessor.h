...
protected:
	...
	Literal * _lit_equivalences;  /// NOTE: position lit records the equivalent literal of lit 记录了lit对应的等价文字
...
protected:
	...
	vector<Literal> * _equivalent_lit_sets;  // it is sorted and each cluster is also sorted, and used for optimize Replace_Equivalent_Lit() 记录了等价类
...
public:
	...
	bool * Y_implied; // thl 记录Y中的变量是否被Ylist蕴含
	void Count_Yimplied( CNF_Formula & cnf ); // thl 计算Y之间的蕴含关系
...
protected:
	...
	Literal Find_Equivalent_Lit_Root( Literal lit ); // thl 并查集找根
